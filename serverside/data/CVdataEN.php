...
[
    "info_raisonsociale" =>
        [
            ...
            development and integration with 25+ years expertise"
        ],
    "info_adresse" =>
        [
    ...
    "boulotentry02content" =>
        [
            [ "Description", "Web development",
                [
                    [ "http://www.njdevpro.fr", "NJDev company website" ],
                    [ "https://github.com/fpignalet/my-website-nj", "Source code" ]
                ]
            ],
            [ "Environment",
                "Development on Windows 10 and Linux Debian 9, with JetBrains (PhpStorm, Datagrid),
                Frontend (responsive) developed with React, Backend developed with Php, then Spring Boot.
                App servers: WAMP Server, Tomcat.
                Databases: MySQL.
...
[
    ...
    "boulotentry03content" =>
        [
            ...
            [ "Environment",
                "Development on Windows 10 and Linux Debian 9, with JetBrains (IntelliJIDEA, PhpStorm, PyCharm, Datagrid). 
                Frontend (responsive) developed with Vanilla Javascript, Backend developed with Php, then Spring Boot.
                Technology survey: React, Angular, Django, Microservices.
                App servers: Apache2, WAMP Server, Tomcat.
...
[
    ...
    "boulotentry11content" =>
        [
            [ "Description", "Frontends and embedded software for IFF interrogators / transponders related tools, based on these products",
                [
            ...
            [ "Environment",
                "Development on Windows 7 and Linux Debian 9 using Eclipse. 
                 C Embedded IoT software, Java Rich-Client with Swing GUI, XML data and Ant deployment. 
                 Unit tests with CUnit, JUnit. 
                 Frontend (responsive) development with Javascript(AJAX), jQuery, React, Node, JSON, 
                 Backend development with Php, 
                 C Microservices with GNU Autotools, Docker, JIRA, Jenkins, SVN, SW requirements in DOORS. 
                 Various com links & specific HW:",
                [
                    "UDP/TCP IP",
                    "RS-232/422/485",
                    "CAN bus",
            ...
            [ "Keypoints",
                "C, C++, Java, Swing, Ant, CUnit, JUnit, Javascript, jQuery, React, Node, AJAX, XML, JSON, GNU Autotools, Docker, JIRA, Jenkins, DOORS, SVN" ],
            [ "Methodology",
                [
                    "AGILE software development",
                    "continuous integration"
...
[
    ...
    "boulotentry21content" =>
        [
            [ "Description", "Frontends and embedded software for the following products (IFF interrogators and transponders related tools)",
                [
                    ...
                    [ "https://www.hensoldt.net/solutions/sea/identification-iff/iff-mode-4mode-5-crypto-computer-qrtkxng-family/", "QRTK" ],
                ]
            ],
            [ "Environment",
                "Development on Windows 7 and Linux Debian 8 using Eclipse. C Embedded software, Java Rich-Client with Swing GUI, XML data and Ant deployment. Unit tests with JUnit. Technology survey: Javascript(AJAX), jQuery, React, Node, JSON. Organisation: 
                 JIRA, SVN, SW requirements in DOORS. Various com links & specific HW:",
                [
                    "UDP/TCP IP",
                    "RS-232/485",
                    [ "https://en.wikipedia.org/wiki/Automatic_dependent_surveillance_%E2%80%93_broadcast", "ADS-B" ],
...
[
    ...
    "boulotentry22content" =>
        [
            [ "Description", "Components developments for a military air control system (SCCOA program)",
                [
                    [ "https://www.nao.org.uk/defencevfm/wp-content/uploads/sites/16/2013/03/france_sccoa_mar_2004_1.pdf", "SCCOA" ],
                ]
            ],
            [ "Environment",
                "Development on Windows 7 and Linux Debian 8 with Eclipse. POJO using Hibernate. Deployment with Ant. SW requirements in DOORS" ],
            [ "Keypoints",
                "Java, XML" ],
            [ "Methodology",
        ...
        [
            [ "Description",
                [
                    ...
                    "New features and bugfixes in a Pure Java Rich Client based on a multithreaded 3 tier architecture which was running on Windows"
                ]
            ],
            [ "Environment",
...
[
    ...
    "boulotentry24content" =>
        [
            [ "Description",
                [
                    "XML Message handling in a military weapon system communication infrastructure",
                    "Huge team ~100 people (70 SW developers)"
                ]
            ],
            [ "Environment", "
                Windows XP, Entreprise Architect, Eclipse, Swt GUI, OSGI, J2EE, EJB, POJO, JAXB, Spring, SVN" ],
            [ "Keypoints",
        ...
        [
            [ "Description",
                [
                    ...
                    "Design and implementation of a multithreaded 3 tier architectured Frontend with extensive use of design patterns: 
                    ...
                    Design and implementation of a WebLogic Backend with PostgreSQL + geographic plugin"
                ]
            ],
            [ "Environment", "
...
[
    ...
    "boulotentry26content" =>
        [
            [ "Description",
                [
                    "Development of the middleware/business logic for a geographic information application (2D & 3D image management for mission preparation and intelligence)",
...
[
    ...
    "boulotentry31content" =>
        [
            [ "Description",
                [
                    "Architecture and development of a real time embedded software inside bus ticketing console",
                    "Development of a virtual machine for 386EX microcontroller emulation"
                ]
            ],
            [ "Environment",
